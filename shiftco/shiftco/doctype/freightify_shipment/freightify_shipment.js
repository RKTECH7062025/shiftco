...
frappe.ui.form.on("Shiftco Shipment", {
	refresh(frm) {
            ...
            frm.add_custom_button(
                ...
                function () {
                    erpnext.utils.map_current_doc({
                        method: "Shiftco.Shiftco.doctype.Shiftco_shipment.Shiftco_shipment.make_Shiftco_shipment",
    ...
    get_item(frm){
        if(frm.doc.schedule_and_rate){
            ...
            if(check_selected==0){
                ...
                frm.call({
                    method: "Shiftco.Shiftco.api.consolidate_item",
                    args: {
                        table:schdeule_rate_table,
                        doctype:"Shiftco Shipment"
                    },
                    freeze:true,    
    ...
    track(frm){
        if(frm.doc.container){
            ...
            frm.call({
                method: "Shiftco.Shiftco.doctype.shipment_rate.shipment_rate.OAuth2_authentication",
                args: {
                    doc:frm.doc,
                },
                async:true,
...
frappe.ui.form.on('Sales Order Item',{
    item_code(frm,cdt,cdn){
        ...
        if(d.item_code && (!d.item_name || !d.uom || !d.conversion_factor)){
            frm.call({
                method: "Shiftco.Shiftco.doctype.Shiftco_shipment.Shiftco_shipment.get_item_detail",
                args: {
    ...
    before_items_remove(frm,cdt,cdn) {
        ...
        if(d.custom_schedule_and_rate_ref){
            ...
            if(check_selected==0){
                ...
                var schdeule_rate_table=frm.doc.schedule_and_rate
                frm.call({
                    method: "Shiftco.Shiftco.doctype.Shiftco_shipment.Shiftco_shipment.consolidate_shipment_item",
                    args: {
                        table:schdeule_rate_table,
                        doctype:"Shiftco Shipment"
                    },
...
frappe.ui.form.on("Shiftco Container",{
    form_render(frm,cdt,cdn){
        var d = locals[cdt][cdn]
...
function check_existing(frm,doctype){
    frm.call({
        method: "Shiftco.Shiftco.doctype.Shiftco_shipment.Shiftco_shipment.check_shipment_shedule_and_rate",
        args: {
            doc:frm.doc,
            doctype:doctype
        },
