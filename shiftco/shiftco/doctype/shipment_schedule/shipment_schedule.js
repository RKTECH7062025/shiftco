...
frappe.ui.form.on("Shipment Schedule", {
        ...
        if(frm.doc.docstatus==1){
            frm.add_custom_button(("Quotation"), function(){
                frappe.model.open_mapped_doc({
                    method:"Shiftco.Shiftco.doctype.shipment_schedule.shipment_schedule.make_quotation_sales_order",
                    frm:frm,
                    args:{
                        doctype:"Quotation"
                    },
            ...
            frm.add_custom_button(("Shipment"), function(){
                if(frm.doc.reference_doctype != "Shiftco Shipment"){
	...
	get_schedules(frm){
        ...
        if(frm.doc.origin && frm.doc.destination && frm.doc.departure_date && frm.doc.duration){
            frm.call({
                method: "Shiftco.Shiftco.doctype.shipment_schedule.shipment_schedule.OAuth2_authentication",
                args: {
                    doc:frm.doc,
                },
                async:true,
...
function check_existing(frm,doctype){
    frm.call({
        method: "Shiftco.Shiftco.doctype.shipment_schedule.shipment_schedule.check_shedule_and_rate",
        args: {
            doc:frm.doc,
            doctype:doctype
        },
        ...
        if(r.message.function=="Success"){
            frappe.model.open_mapped_doc({
                method:"Shiftco.Shiftco.doctype.shipment_schedule.shipment_schedule.make_shipment",
                frm:frm,
                args:{
